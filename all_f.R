...
heatmapComparisonMulti = function(dfs, samples, filename, filepath, correction_factors, labels=F, xlab=T, tri=T, dendrogram=T) {
  ...
  if (dendrogram) {
    ...
    my_palette1=colorRampPalette(Colors)(n = 499)
    ...
    heatmap.2(dend_mat, scale = "none", dendrogram = "both", breaks=my_breaks, col = my_palette1, trace = "none", margins=c(10,5), srtCol=45, symm=F,symkey=F,symbreaks=T, main="Magnitude of Expression")
    dev.off()
