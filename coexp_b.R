...
obj <- bb
obj = subset(obj, cells = colnames(obj)[which(obj$cond == "BHVE")])
...
saveRDS(mat3_trans, "~/scratch/brain/data/bb_b_j.RDS")
saveRDS(mat3_trans_p, "~/scratch/brain/data/bb_b_j_p.RDS")
