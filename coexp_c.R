...
obj <- bb
obj = subset(obj, cells = colnames(obj)[which(obj$cond == "CTRL")])
...
saveRDS(mat3_trans, "~/scratch/brain/data/bb_c_j.RDS")
saveRDS(mat3_trans_p, "~/scratch/brain/data/bb_c_j_p.RDS")
